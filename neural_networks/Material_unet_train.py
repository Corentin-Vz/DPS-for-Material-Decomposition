...
my_transforms = transforms.Compose(
    [transforms.ToTensor(),
     ...
     transforms.ElasticTransform(alpha=10.)] 
)                                                       
...
ddpm_model = UNet(image_channels = 2, n_channels=32, n_blocks=2)
...
# ckpt_name = "../checkpoints_spectral/nn_weights/material_sept.pth"
...
writer = SummaryWriter(log_dir="../checkpoints_material/runs_new/")
...
for epoch in range(n_epochs):
    ...
    writer.add_scalars('run', {'Train_sept': avg_loss/num_items,
                                'Val_sept': avg_loss_val/ num_items_val}, epoch)    
#     scheduler.step()
