...
data_train = DataLoader_spectral(img_dir ='../Data/', energy_list=energy_list, patient_list=patient_list, transform=my_transforms)
data_val = DataLoader_spectral(img_dir ='../Data/', energy_list=energy_list, patient_list=patient_list_val, transform=my_transforms)
...
mean = torch.tensor(np.load('../Data/mean_spectral.npy'))[None,:,None,None]
std = torch.tensor(np.load('../Data/std_spectral.npy'))[None,:,None,None]
